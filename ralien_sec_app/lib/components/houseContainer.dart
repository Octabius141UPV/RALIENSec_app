    ...
    for (int i = 0; i < houses.length; i++) {
      ...
      for (int j = 0; j < houses[i]["userprofiles"].length; j++) {
        String stringWithName =
            "${houses[i]["userprofiles"][j]["id"]}_${houses[i]["userprofiles"][j]["image_id"]}";
        ...
        checkFileExistence(filePath, (bool fileExists) {
          ...
          if (fileExists) {
            ...
            saveImage(
                houses[i]["userprofiles"][j]["profile_image"],
                houses[i]["userprofiles"][j]["id"],
                houses[i]["userprofiles"][j]["image_id"]);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(12, 5, 12, 1),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
